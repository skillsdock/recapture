...
interface SettingsPanelProps {
	...
	onAnnotationEmojiDataChange?: (id: string, emojiData: EmojiData) => void;
	...
	if (
		...
		return (
			<AnnotationSettingsPanel
				...
				onEmojiDataChange={
					onAnnotationEmojiDataChange
						? (emojiData) => onAnnotationEmojiDataChange(selectedAnnotation.id, emojiData)
						: undefined
				}
			...
			<div className="flex-shrink-0 p-4 pt-3 border-t border-white/5 bg-[#09090b]">
				...
				<div className="flex gap-2 mt-3">
					<button
						...
						onClick={() => {
							window.electronAPI?.openExternalUrl(
								"https://github.com/skillsdock/recapture/issues/new/choose",
							);
						}}
					...
					<button
						type="button"
						onClick={() => {
							window.electronAPI?.openExternalUrl("https://github.com/skillsdock/recapture");
						}}
						className="flex-1 flex items-center justify-center gap-1.5 text-[10px] text-slate-500 hover:text-slate-300 py-1.5 transition-colors"
					>
